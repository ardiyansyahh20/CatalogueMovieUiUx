...
import static com.ardi.cataloguemovieuiux.Database.DatabaseContract.AUTHORITY;
...
public class FilmProvider extends ContentProvider {
    ...
    static {
        sUrimatcher.addURI(AUTHORITY, DatabaseContract.TABLE, MOVIE);
        sUrimatcher.addURI(AUTHORITY, DatabaseContract.TABLE + "/#", MOVIE_ID);
    }
